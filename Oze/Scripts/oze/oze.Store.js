...
function getParams() {
    return { StoreId: $("#StoreId").val(), s: $("#txtSearch").val(), offset: $table.bootstrapTable('getOptions').pageNumber, limit: $table.bootstrapTable('getOptions').pageSize }
}
...
function editDialog(id) {
    ...
    $("#myModal").on('show.bs.modal', function () {
        ...
        $("#myModal .modal-body-content").load("/Store/Edit/" + id);
        ...
        $("#btnSave").click(function () {
            ...
            showDialogLoading();
                $.post("/Store/Update", { obj: pdata }, function (data) {
                    hideDialogLoading();
                    //closeDlgLoadingData();
                    if (data.result > 0) {
...
function viewDialog(id) {
    ...
    $("#myModal").on('show.bs.modal', function () {
        $("#myModal .modal-body-content").load("/Store/GetDetail/" + id);
...
function viewRoom(id) {
    ...
    $("#modalRoom").on('show.bs.modal', function () {
        $("#modalRoom .modal-body-content").load("/Store/GetRoom/" + id);
    });
